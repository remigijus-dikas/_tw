<?php
/**
 * Undertailwind functions and definitions
 *
...
function _tw_setup() {
	/*
		...
		* If you're building a theme based on Undertailwind, use a find and replace
...
function _tw_content_width() {
	$GLOBALS['content_width'] = apply_filters( '_tw_content_width', 1288 );
}
